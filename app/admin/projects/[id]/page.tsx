...
import { FolderKanban, FileText, Github, User, Calendar, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-extrabold text-gray-900 mb-2">Project Review</h1>
        <p className="text-gray-600">Review and provide feedback on student project</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              {submission.githubRepo && (
                <div>
                  ...
                  >
                    <Github size={20} />
                    <span>{submission.githubRepo}</span>
                  </a>
                </div>
              )}
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-6 sticky top-8">
            <ProjectReviewForm submissionId={submission.id} currentStatus={submission.status} />
          </div>
        </div>
      </div>
    </div>
